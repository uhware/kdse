...
#ifndef KDSE16_COMPUTE_H
#define KDSE16_COMPUTE_H
 ...
 * recovery. The supplied KDSE-16 value must already be valid. Ordered form is
 * not required. Bit 15 remains outside the payload and is ignored.
 *
 ...
 *
 * Preconditions:
 * - validated_value contains a valid minimal-form KDSE-16 payload;
 ...
 *
 * @param validated_value Previously validated KDSE-16 container.
